export const PALETTES = {
  ...
  rose: {
    label: '로즈', swatch: '#e11d48',
    vars: {
      '--indigo-50':  '#fff1f2', '--indigo-100': '#ffe4e6',
      '--indigo-500': '#f43f5e', '--indigo-600': '#e11d48',
      '--indigo-700': '#be123c', '--indigo-900': '#881337',
      '--indigo-950': '#4c0519',
      '--text-sidebar': '#fecdd3', '--text-sidebar-sub': '#fda4af',
    },
  },
  amber: {
    label: '앰버', swatch: '#d97706',
    vars: {
      '--indigo-50':  '#fffbeb', '--indigo-100': '#fef3c7',
      '--indigo-500': '#f59e0b', '--indigo-600': '#d97706',
      '--indigo-700': '#b45309', '--indigo-900': '#78350f',
      '--indigo-950': '#451a03',
      '--text-sidebar': '#fde68a', '--text-sidebar-sub': '#fcd34d',
    },
  },
  purple: {
    label: '퍼플', swatch: '#9333ea',
    vars: {
      '--indigo-50':  '#faf5ff', '--indigo-100': '#f3e8ff',
      '--indigo-500': '#a855f7', '--indigo-600': '#9333ea',
      '--indigo-700': '#7e22ce', '--indigo-900': '#581c87',
      '--indigo-950': '#3b0764',
...
export function applyColorPalette(name) {
